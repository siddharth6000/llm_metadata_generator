"""Optimized LLM provider implementations and communication logic."""
...
def _query_openai_llm(prompt, config, openai_client, max_tokens=300, temperature=0.7):
...
def _query_local_llm(prompt, config, max_tokens=300, temperature=0.7):
